 ...
 pragma solidity 0.4.11;
  ...
  /**
   * @title 3DX Vesting
   * @dev 3DXVesting is a token holder contract that allows the specified beneficiary
   * to claim stored tokens after 1 month intervals
  */

   contract 3DXVesting is SafeMath {
      ...
      function 3DXVesting(address _token, uint256 fundingEndBlockInput) {
      ...
      // in total 13% of 3DX tokens will be sent to this contract
      ...
      // initial claim is thus (5.5 + 1.5)/13 = 53.846153846% of 3DX tokens sent here
